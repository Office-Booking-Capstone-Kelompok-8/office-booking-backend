...
func (r *Routes) Init(app *fiber.App) {
	...
	payment.Get("/:reservationID", r.accessTokenMiddleware, middlewares.EnforceValidEmail(), r.payment.GetUserReservationPaymentByID)
	...
	aPayment.Post("/methods", r.adminAccessTokenMiddleware, r.payment.CreatePaymentMethod)
	aPayment.Put("/methods/:paymentMethodID", r.adminAccessTokenMiddleware, r.payment.UpdatePaymentMethod)
	aPayment.Delete("/methods/:paymentMethodID", r.adminAccessTokenMiddleware, r.payment.DeletePaymentMethod)
	aPayment.Get("/:reservationID", r.adminAccessTokenMiddleware, r.payment.GetReservationPaymentByID)
}
